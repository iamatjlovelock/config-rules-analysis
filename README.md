...
```bash
# Generate conformance pack for a framework
python utility-scripts/generate_conformance_pack_from_framework.py \
  --framework-id 1f50f59a-fc3c-4b99-be05-6a79cf3f9538

# Output to stdout instead of file
python utility-scripts/generate_conformance_pack_from_framework.py \
  --framework-id 1f50f59a-fc3c-4b99-be05-6a79cf3f9538 --stdout

# Specify custom output path
python utility-scripts/generate_conformance_pack_from_framework.py \
  --framework-id 1f50f59a-fc3c-4b99-be05-6a79cf3f9538 -o custom-output.yaml
```

**Key Features:**
- Extracts all AWS_Config rule identifiers from the framework
- Resolves Core Control references to get underlying Config rules
- Generates a valid AWS Config conformance pack YAML template
- Outputs to `audit-manager-framework-templates/<framework-id>.yaml` by default

**Output:**
```
audit-manager-framework-templates/
└── 1f50f59a-fc3c-4b99-be05-6a79cf3f9538.yaml   # PCI DSS v4.0 (202 rules)
```
